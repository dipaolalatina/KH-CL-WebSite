...
<html>
    <head>
      ...
      <title>King's Hawaiian - Historia</title>
        <meta charset="UTF-8">
        ...
        <meta name="description" content="King's Hawaiian - Historia">
    ...
    <body>
        ...
        <?php include_once "../templates/top_nav_historia.html";?>
        <?php include_once "../templates/page-historia.php";?>
